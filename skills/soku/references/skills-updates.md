...
This skill records the CLI release it was written against in a `cliVersion`
note right below its frontmatter. If the installed CLI is newer, run the command
